# LICENSING
- Licensing for code that individuals have contributed template

## Each pages of code will have one of the following License Assotiated

```
Copyright (C) <year> Bellande Application Interoperability Xenogen Research Innovation Center.
